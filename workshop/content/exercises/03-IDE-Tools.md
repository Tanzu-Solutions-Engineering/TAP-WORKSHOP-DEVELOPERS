...
```execute
tanzu accelerator generate spring-sensors-rabbit --server-url https://accelerator.{{ ENV_VIEW_CLUSTER_DOMAIN }}
```
...
```editor:open-file
file: spring-sensors-rabbit/src/main/java/org/tanzu/demo/DemoController.java
```
...
```editor:open-file
file: spring-sensors-rabbit/Tiltfile
``` 
